...
public class Curso {
	...
	public void adicionarAluno(Aluno aluno) throws ModelException{
		if(aluno == null) {
			throw new ModelException("Aluno não pode ser nulo ao ser adicionado.");
		}
	...
	public void removerAluno(Aluno aluno) throws ModelException{
		if(aluno == null) {
			throw new ModelException("Aluno não pode ser nulo ao ser removido.");
		}
	...
	public static void validarCodigo(int codigo) throws ModelException{
		if(codigo <=0) {
			throw new ModelException("O codigo do curso deve ser maior que 0.");
		}
	}
